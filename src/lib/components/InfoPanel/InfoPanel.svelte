...
{#if loadState }
    ...
    <span class="has-text-dark p-1 px-2 is-size-5 has-text-left block has-text-weight-semibold is-uppercase has-background-danger">
        Corporate Landlord
    </span>
    <div class="is-uppercase title has-text-dark is-size-1 has-text-left block">
