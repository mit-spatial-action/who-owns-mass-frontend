<script>
    ...
    var evictor_rank_desc; 

    if(evictor_rank == "Extreme Evictor"){
        evictor_rank_desc = "This landlord is one of the top evictors in the state of Massachusetts (top 10%)"
    } else if (evictor_rank == "Moderate Evictor"){
