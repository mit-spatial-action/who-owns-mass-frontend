<script lang="ts">
    ...
    let sortedData = $derived(
        activeTab === "properties" ? townGroups : ownerGroups,
    );
</script>
            ...
            <div class="panel is-link is-clickable">
                ...
                >
                    ...
                    <span class="icon">
                        <i
                            class="fas"
                            class:fa-plus={!openPanels.includes(index)}
                            class:fa-minus={openPanels.includes(index)}
                        ></i>
                    </span>
                </span>
                {#if openPanels.includes(index)}
                            ...
                            {#each sites as site}
                                <div class="cell">
                                    <div
                                        ...
                                        role="button"
                                        tabindex="0"
                                        aria-label="Select {site.properties
                                            .address}"
                                        ...
                                        <div class="card-content">
                                            ...
                                            >
                                                <div>
                                                    ...
                                                    <div>
                                                        {#if site.properties.address.muni}{`${site.properties.address.muni}, `}{/if}
                                                        {#if site.properties.address.state}{`${site.properties.address.state} `}{/if}
                                                        {#if site.properties.address.postal}{site
                                                                .properties
                                                                .address
                                                                .postal}{/if}
                                                    </div>
